...
write_xarray_to_netcdf(u, "u_20181121210000_E3.nc", engine ="netcdf4")
write_xarray_to_netcdf(v, "v_20181121210000_E3.nc", engine ="netcdf4")
write_xarray_to_netcdf(t, "t_20181121210000_E3.nc", engine ="netcdf4")
write_xarray_to_netcdf(q, "q_20181121210000_E3.nc", engine ="netcdf4")
