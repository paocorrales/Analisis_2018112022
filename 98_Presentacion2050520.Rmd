...
perfiles  %>% 
  ggplot(aes(date, lev)) +
  geom_contour_fill(aes(z = U_E5_E4)) +
  scale_fill_divergent(name = NULL,
                       # breaks = seq(-1, 1, 0.2),
                       guide = guide_colorstrip(inside = TRUE,
                                                barwidth = 25,
...
perfiles  %>% 
  ggplot(aes(date, lev)) +
  geom_contour_fill(aes(z = U_E6_E5)) +
  scale_fill_divergent(name = NULL,
                       # breaks = seq(-0.2, 0.2, 0.05),
                       guide = guide_colorstrip(inside = TRUE,
                                                barwidth = 25,
...
perfiles  %>% 
  ggplot(aes(date, lev)) +
  geom_contour_fill(aes(z = V_E5_E4)) +
  scale_fill_divergent(name = NULL,
                       # breaks = seq(-1, 1, 0.2),
                       guide = guide_colorstrip(inside = TRUE,
                                                barwidth = 25,
...
perfiles  %>% 
  ggplot(aes(date, lev)) +
  geom_contour_fill(aes(z = V_E6_E5)) +
  scale_fill_divergent(name = NULL,
                       # breaks = seq(-0.2, 0.2, 0.05),
                       guide = guide_colorstrip(inside = TRUE,
                                                barwidth = 25,
...
perfiles  %>% 
  ggplot(aes(date, lev)) +
  geom_contour_fill(aes(z = SPD_E5_E4)) +
  scale_fill_divergent(name = NULL,
                       # breaks = seq(-1, 1, 0.2),
                       guide = guide_colorstrip(inside = TRUE,
                                                barwidth = 25,
...
perfiles  %>% 
  ggplot(aes(date, lev)) +
  geom_contour_fill(aes(z = SPD_E6_E5)) +
  scale_fill_divergent(name = NULL,
                       # breaks = seq(-0.2, 0.2, 0.05),
                       guide = guide_colorstrip(inside = TRUE,
                                                barwidth = 25,
...
- Validation of forecasts using observations from the RELAMPAGO campaign
...
Estudio del incremento de la predictibilidad de la convección profunda en los casos seleccionados a partir de la inclusión de los datos de satélite. Se utilizará la técnica Ensemble Sensitivity to Observations (EFSO, Kalnay et al. 2012) para determinar el impacto relativo de los diferentes conjuntos de observaciones en la calidad de los análisis y pronósticos a corto plazo
---