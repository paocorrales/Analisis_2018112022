...
cape %>% 
  ...
  facet_wrap(~exp, labeller = labeller(exp = c(E3 = "CONV+AUT", E4 = "CONV", E5 = "CONV+AUT OK")), ncol = 1) +
...
cape[date %in% ymd_h(c("2018-11-22 00",
  ...
  facet_grid(exp ~ date, labeller = labeller(exp = c(E3 = "CONV+AUT", E4 = "CONV", E5 = "CONV+AUT OK"))) +
