...
coord <- ReadNetCDF("analisis/mucape/mcape_ana_E3_20181120180000.nc", 
                    vars = c(lon = "XLONG")) %>% 
...
ggsave("fig/pp_acum.png", dpi = 200, width = unit(15, "cm"), height = unit(20, "cm"))
```
...
pp_hov_acum[coord[south_north == 120, .(west_east, lon)], on = c("west_east")] %>% 
  ...
  scale_y_datetime(date_breaks = "6 hours", date_labels = "%b-%d %HZ", expand = c(0,0)) +
...
ggsave("fig/pp_hov.png", dpi = 200, width = unit(20, "cm"), height = unit(20, "cm"))
```
